...
import com.wooplr.base.controller.DefaultTestNGContext;
import com.wooplr.base.helper.XMLHelper;
...
public class ContextManager {
	...
	private static List<IContexAttributeListener> contexAttributeListenerList = Collections
			.synchronizedList(new ArrayList<IContexAttributeListener>());
